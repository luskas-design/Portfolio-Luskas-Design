...
export const translations = {
  pt: {
    ...
    marquee: [
      ...
      'Figma', 'Photoshop', 'UX Research', 'Design System', 'Inteligência Artificial',
    ],
    work: {
      badge: 'Cases',
    ...
    about: {
      badge: 'Sobre mim',
      infoItems: ['Lucas Santos', 'Publicitário e Designer', '+6 anos de experiência', '25 anos'],
      heading: 'Apaixonado por videogame e música',
  ...
  en: {
    ...
    marquee: [
      ...
      'Figma', 'Photoshop', 'UX Research', 'Design System', 'Artificial Intelligence',
    ],
    work: {
      badge: 'Cases',
    ...
    about: {
      badge: 'About me',
      infoItems: ['Lucas Santos', 'Advertiser & Designer', '+6 years of experience', '25 years old'],
      heading: 'Passionate about gaming and music',
