...
export const projects: Project[] = [
  ...
  {
    id: 10, slug: 'laundry-turtle',
    title: 'Laundry Turtle',
    description: 'Protótipo conceitual do novo site da marca',
    descriptionEn: 'Conceptual prototype for the brand\'s new website',
    tags: ['UI DESIGN'], year: '2025', type: 'UI Design', featured: true,
    image: '/images/projects/laundry-turtle.jpg',
    behanceUrl: 'https://www.behance.net/gallery/251177353/Laundry-Turtle-Website-Concept-Project',
  },
  {
    id: 8, slug: 'rha-moveis',
    title: 'RHA Móveis',
    description: 'Homepage no segmento de móveis corporativos',
    descriptionEn: 'Homepage for corporate furniture segment',
    tags: ['UI DESIGN'], year: '2025', type: 'UI Design',
    image: '/images/projects/rha.jpg',
    behanceUrl: 'https://www.behance.net/gallery/240530361/RHA-Moveis-Product-Design-Website-Prototype',
  },
  {
    id: 9, slug: 'weg-solar',
    title: 'WEG Home/Solar',
    description: 'Protótipo das páginas de subprodutos WEG',
    descriptionEn: 'Prototype of WEG sub-product pages',
    tags: ['UI DESIGN'], year: '2023', type: 'UI Design',
    image: '/images/projects/weg.jpg',
    behanceUrl: 'https://www.behance.net/gallery/211837095/WEG-HomeSolar-New-Website-UI-Design',
  },
];
